	  ...
	  'use strict';
		...
		function fCheck() {
			...
			if(fileSize > maxSize){
  			...
  			if(fName == "") {
  				myForm.imsiFname.value = '${vo.fName}';
  				myForm.imsiFSname.value = '${vo.fSName}';
  			}
...
<p><br/></p>
<div class="container">
  <form name="myForm" method="post" action="${ctp}/foUpdateOk.fo" enctype="multipart/form-data">
  	<h2>식 단 게 시 글 수 정</h2>
  	<div class="form-group"> 
  		...
  		<c:if test="${not empty vo.fName}">
	  		...
	  		<c:forEach var="fName" items="${fNames}" varStatus="st">
	  		  ${st.count}. ${fName} / &nbsp;
	  		</c:forEach><a href="javascript:fSNameDelete('${vo.idx}','${vo.fSName}')" class="btn btn-danger btn-sm">삭제</a>
  		</c:if>
  	...
  	<div class="form-group">
  		...
  		<textarea rows="15" name="content" id="content" class="form-control">${vo.content}</textarea>
  	</div>
  	<div class="form-group">
