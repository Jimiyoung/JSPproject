...
<div class="container">
  <form name="myForm" method="post" action="${ctp}/foInputOk.fo" enctype="multipart/form-data">
  	<h2>식 단 표 등 록</h2>
  	...
  	<div class="form-group">
  		...
  		<textarea rows="15" name="content" id="content" class="form-control"></textarea>
  	</div>
  	<div class="form-group">
  	...
  	<div class="form-group text-center">
  		...
  		<input type="button" value="돌아가기" onclick="location.href='${ctp}/foList.fo';" class="btn btn-secondary"/>
  	</div>
