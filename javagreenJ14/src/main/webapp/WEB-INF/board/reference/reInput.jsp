...
<div class="container">
  <form name="myForm" method="post" action="${ctp}/reInputOk.re">
	  <table class="table table-borderless">
	    <tr>
	      <td><h2>교육자료실 글쓰기</h2></td>
	    </tr>
	  </table>
	  <table class="table">
	    <tr>
	    ...
	    <tr>
	      <td colspan="2" class="text-center">
	        ...
	        <input type="button" value="돌아가기" onclick="location.href='${ctp}/reList.re';" class="btn btn-secondary"/>
	      </td>
	    </tr>
	  </table>
  </form>
