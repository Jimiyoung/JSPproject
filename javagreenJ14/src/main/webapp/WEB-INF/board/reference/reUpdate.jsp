...
<div class="container">
  <form name="myForm" method="post" action="${ctp}/reUpdateOk.re">
	  <table class="table table-borderless">
	    <tr>
	      <td><h2>교육자료실 수정하기</h2></td>
	    </tr>
	  </table>
	  <table class="table">
	    <tr>
	    ...
	    <tr>
	      <td colspan="2" class="text-center">
	        ...
	        <input type="button" value="돌아가기" onclick="location.href='${ctp}/reList.re?pag=${pag}&pageSize=${pageSize}';" class="btn btn-secondary"/>
	      </td>
	    </tr>
	  </table>
